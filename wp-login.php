...
function login_header( $title = 'Log In', $message = '', $wp_error = null ) {
	...
	<title>
		 <?php 
		 //$titleCus= str_replace("__WordPress","",$login_title);echo $titleCus; ?>  
		Login> ASK Blogs
	</title>
	<?php
	...
	<body style="background-color:rgb(19, 16, 16);" class="login no-js <?php echo esc_attr( implode( ' ', $classes ) ); ?>">
	<?php
	...
	<div id="login">
		<h1>
			<img style="height:100px;border-radius:50px;border:2px solid red;" src="wp-admin/images/logo_ask.jpg" alt="">
...
switch ( $action ) {
	...
	default:
		...
		<form name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post">
			<p>
				<label for="user_login"><?php _e( 'Username or Email Address' ); ?></label>
				<input type="text" placeholder="Enter 'admin'" name="log" id="user_login"<?php echo $aria_describedby; ?> class="input" value="<?php echo esc_attr( $user_login ); ?>" size="20" autocapitalize="off" autocomplete="username" required="required" />
			</p>

			<div class="user-pass-wrap">
				<label for="user_pass"><?php _e( 'Password' ); ?></label>
				<div class="wp-pwd">
					<input type="password" placeholder="Enter 'admin'" name="pwd" id="user_pass"<?php echo $aria_describedby; ?> class="input password-input" value="" size="20" autocomplete="current-password" spellcheck="false" required="required" />
